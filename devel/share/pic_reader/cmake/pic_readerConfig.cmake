...
if("TRUE" STREQUAL "TRUE")
  set(pic_reader_SOURCE_PREFIX /home/sibohao/master_arbeit/src/pic_reader)
  set(pic_reader_DEVEL_PREFIX /home/sibohao/master_arbeit/devel)
  ...
  set(pic_reader_INSTALL_PREFIX /home/sibohao/master_arbeit/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pic_reader' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sibohao/master_arbeit/src/pic_reader/${idir}'.  ${_report}")
    endif()
