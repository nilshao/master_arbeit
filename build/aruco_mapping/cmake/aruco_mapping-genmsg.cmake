...
set(MSG_I_FLAGS "-Iaruco_mapping:/home/sibohao/Desktop/master_arbeit/src/aruco_mapping/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/sibohao/Desktop/master_arbeit/src/aruco_mapping/msg/ArucoMarker.msg" NAME_WE)
add_custom_target(_aruco_mapping_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "aruco_mapping" "/home/sibohao/Desktop/master_arbeit/src/aruco_mapping/msg/ArucoMarker.msg" "geometry_msgs/Pose:geometry_msgs/Point:geometry_msgs/Quaternion:std_msgs/Header"
)
...
_generate_msg_cpp(aruco_mapping
  "/home/sibohao/Desktop/master_arbeit/src/aruco_mapping/msg/ArucoMarker.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/aruco_mapping)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/aruco_mapping\")")
  # install generated code
  install(
